...
public class DynamicDataPage<T> implements DataPage<T>, ComplexPage {
	...
	/* (non-Javadoc)
	 * @see com.rwhq.btree.DataPage#add(byte[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.rwhq.btree.DataPage#remove(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.rwhq.btree.DataPage#get(int)
	 */
	@Override
	...
	private int sizeOfEntryAt(final int offset){
		...
		/* (non-Javadoc)
	 * @see com.rwhq.btree.DataPage#remaining()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.rwhq.io.rm.ComplexPage#isValid()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.rwhq.io.rm.ComplexPage#rawPage()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DataPage#pagePointSerializer()
	 */
	@Override
