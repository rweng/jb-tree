...
gradle tasks
# if you are in eclipse, generate the eclipse files to be able to open the folder as eclipse project
gradle eclipse
# run the tests (currently, only the BTreeSpec should fail)
gradle test
