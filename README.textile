...
bc. git clone git://github.com/rweng/index.git
cd index
...
You can perform all those operations on the master branch which contains the latest releases and hotfixes. If you want to start developing or see the current status, check out the development branch after cloning the repository
